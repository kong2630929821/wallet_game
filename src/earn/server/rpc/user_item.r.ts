...
import { AWARD_SRC_ADVERTISEMENT, MAX_ONEDAY_ADAWARD, MAX_ONEDAY_MINING, MEMORY_NAME, MIN_ADVERTISEMENT_SECONDS, RESULT_SUCCESS, WARE_NAME } from '../data/constant';
import { Result } from '../data/db/guessing.s';
import { Award, AwardList, AwardQuery, BTC, DailyWatchAdNum, ETH, Hoe, Item, Items, KT, Mine, ST, TodayMineNum } from '../data/db/item.s';
import { Achievements, Medals, ShowMedal, ShowMedalRes } from '../data/db/medal.s';
import { ADVERTISEMENT_NUM_ERROR, ADVERTISEMENT_TIME_ERROR, DB_ERROR, ONEDAY_ADAWARD_LIMIT } from '../data/errorNum';
