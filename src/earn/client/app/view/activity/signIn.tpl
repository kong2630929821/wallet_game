    ...
    <div w-class="body">
        ...
        <div w-class="main">
            {{for item of it.awards}}
                <div style="margin:5px;"><earn-client-app-components-signInAward-signInAward>{ continuedDays:{{ item.days }},hoeType:{{ item.prop }},received:{{ it.signInDays >= item.days }} }</earn-client-app-components-signInAward-signInAward></div>
            {{end}}
        </div>
