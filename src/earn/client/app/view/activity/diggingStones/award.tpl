    ...
    <div w-class="body">
        <div>
            ...
            <div w-class="award-gifts">
                ...
                <earn-client-app-view-activity-components-awardGift style="margin-top:50px;">{"width":180,"borderWidth":8,"activeColor":"#F7931A","activePercent":0.4,"centerImage":"../../../res/image/award_gold_hoe.png",firstText:"1/2",secondText:"每日登录"}</earn-client-app-view-activity-components-awardGift>
                {{end}}
            </div>
            {{else}}
            <div w-class="award-gifts">
                {{for i of [0,0,0,0,0,0,0,0,0]}}
                <earn-client-app-view-activity-components-awardGift style="margin-top:50px;">{"width":180,"borderWidth":8,"activeColor":"#F7931A","activePercent":0.4,"centerImage":"../../../res/image/award_gold_hoe.png",firstText:"1-3人"}</earn-client-app-view-activity-components-awardGift>
                {{end}}
            </div>
            {{end}}
        </div>
