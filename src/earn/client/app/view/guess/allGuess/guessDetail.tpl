<div class="new-page" w-class="new-page" ev-back-click="backPrePage">
    ...
    <div w-class="content">
        <div>
            ...
            <div w-class="guess-box">
                ...
                <div w-class="guess-btn-box">
                    <div w-class="guess-btn left-guessbtn">为IG加油</div>
                    <div w-class="guess-btn right-guessbtn">为IG加油</div>
                </div>
        ...
        <div w-class="bottom">
            <widget w-tag="pi-ui-lang">{"zh_Hans":"我的ST：10ST","zh_Hant":"我的ST：10ST","en":""}</widget>
