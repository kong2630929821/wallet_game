...
winit.loadJS(winit.domains, winit.path + 'earn/editor/boot/init.js?' + Math.random(), "utf8", winit.initFail, "load init error");
winit.loadJS(winit.domains, winit.path + 'earn/editor/boot/next.js?' + Math.random(), "utf8", winit.initFail, "load next error");
