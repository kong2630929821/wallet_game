...
export class UserAcc extends Struct {
    ...
    user: string;
    uid: number;
	static _$info =  new StructInfo("server/tmp/db/user.UserAcc",700841775,  new Map( [["primary","user"],["db","file"],["dbMonitor","true"],["hasmgr","false"]]), [new FieldInfo("user", 
...
export class UserInfo extends Struct {
    ...
    tel: string;
    note: string;
	static _$info =  new StructInfo("server/tmp/db/user.UserInfo",656745663,  new Map( [["primary","uid"],["db","file"],["dbMonitor","true"],["hasmgr","false"]]), [new FieldInfo("uid", 
...
export class IDIndex extends Struct {
    ...
    index: string;
    id: number;
	static _$info =  new StructInfo("server/tmp/db/user.IDIndex",2515680168,  new Map( [["primary","index"],["db","file"],["dbMonitor","true"],["hasmgr","false"]]), [new FieldInfo("index", 
...
export class Online extends Struct {
    ...
    uid: number;
    session_id: number;
	static _$info =  new StructInfo("server/tmp/db/user.Online",3204685507,  new Map( [["primary","uid"],["db","memory"]]), [new FieldInfo("uid", 
...
export class OnlineMap extends Struct {
    ...
    session_id: number;
    uid: number;
	static _$info =  new StructInfo("server/tmp/db/user.OnlineMap",1682064955,  new Map( [["primary","session_id"],["db","memory"]]), [new FieldInfo("session_id", 
