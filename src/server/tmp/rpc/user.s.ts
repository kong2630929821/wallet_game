...
export class WalletLoginReq extends Struct {
    ...
    openid: string;
    sign: string;
	static _$info =  new StructInfo("server/tmp/rpc/user.WalletLoginReq",3614460511, null, [new FieldInfo("openid", 
...
export class LoginReply extends Struct {
    ...
    status: number;
	static _$info =  new StructInfo("server/tmp/rpc/user.LoginReply",2523273921, null, [new FieldInfo("status", 
...
export class LoginReq extends Struct {
    ...
    uid: number;
	static _$info =  new StructInfo("server/tmp/rpc/user.LoginReq",2528565806, null, [new FieldInfo("uid", 
...
export class UserType extends Struct{
    ...
    static _$info = new EnumInfo('server/tmp/rpc/user.UserType', 2348141653, null,  [
